...
import { handleBasicSignup, handleOtp, handleOrganizationDetails, handleResendOTP } from "../helpers/Auth/authApi";
import { TBasicSignupFormInputs, TOrgazinationDetails, TVerifyEmail } from "../src/types/Auth.types";

jest.mock("axios");

const TEMP_BACKEND_URI = "https://ops4team-test.onrender.com"; // Updated to match the actual backend URI
...
describe("authApi", () => {
  ...
  //     expect(mockedAxios.post).toHaveBeenCalledWith(`${TEMP_BACKEND_URI}/auth/register`, mockData, {
  ...
  //     expect(result).toEqual(mockResponse.data);
  //     expect(mockedAxios.post).toHaveBeenCalledWith(`${TEMP_BACKEND_URI}/auth/register/verify-email`, mockData, {
  //       headers: { "Content-Type": "application/json" },
  //     });
  //   });

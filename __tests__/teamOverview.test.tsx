...
jest.mock('../src/app/(dashboards)/members/[id]/member-details/_components/TeamDetailsTable', () => ({
  TeamDetailsTable: () => <div data-testid="team-details-table">Mock Team Table</div>,
}));

jest.mock('../src/app/(dashboards)/members/[id]/member-details/_components/customDatePicker', () => ({
...
jest.mock('../src/components/AvatarMenu', () => {
  const MockAvatarMenu = () => (
    <div data-testid="avatar-menu">Mock Avatar Menu</div>
  );
  MockAvatarMenu.displayName = 'MockAvatarMenu';
  return MockAvatarMenu;
});

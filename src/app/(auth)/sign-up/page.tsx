...
const SignUpContent = () => {
  ...
  return (
    <div className="grid h-screen w-full grid-cols-1 overflow-y-hidden md:grid-cols-2">
      <PageTitle pageName="Create Account" title="Try Ops4 Team for Free • Ops4 Team" />
      ...
      <div className="w-full overflow-y-auto bg-white pb-4">
        ...
        <div className="mx-auto w-full max-w-[465px] px-8 pb-5 pt-6 lg:px-5 lg:pt-0 xl:pt-8">
          <div>
            <p className="pt-6 text-3xl font-semibold text-black lg:pb-6">Sign up</p>
            <AuthPageHeader
              ...
              <div className="relative">
                ...
                <button type="button" onClick={handlePasswordVisibility} className="absolute right-5 top-2.5">
                  {passwordVisible ? (
                    ...
                    <EyeOff size={20} className="text-xl font-normal text-deepBlackColor" />
                  )}
                </button>
              </div>
            </div>
          ...
          <div>
            <p className="px-10 pt-3 text-center text-sm text-textMuted" onClick={() => comingSoonAlert()}>
              By clicking continue, you agree to our {""}
              <span className="cursor-pointer underline">Terms of Service</span> and <span className="cursor-pointer underline">Privacy Policy</span>.
            </p>
          </div>
        </div>
      </div>

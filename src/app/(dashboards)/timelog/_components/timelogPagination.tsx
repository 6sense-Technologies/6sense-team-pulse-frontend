...
export function TimelogPagination({ currentPage, totalPage, onPageChange }: PaginationProps) {
          ...
          <PaginationPrevious
            ...
            onClick={(e) => {
              ...
              if (currentPage > 1) {
                ...
                router.push(`/timelog?page=${currentPage - 1}`);
              }
            }}
          />
        </PaginationItem>

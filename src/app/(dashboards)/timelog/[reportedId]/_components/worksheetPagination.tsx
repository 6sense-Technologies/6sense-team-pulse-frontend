...
export function WorksheetPagination({ currentPage, totalPage, onPageChange, reportedId }: PaginationProps) {
          ...
          <PaginationPrevious
            ...
            onClick={(e) => {
              ...
              if (currentPage > 1) {
                ...
                router.push(`/timelog/${reportedId}?page=${currentPage - 1}`);
              }
            }}
          />
        </PaginationItem>
            ...
            {typeof page === "number" ? (
              <PaginationLink
                ...
                onClick={(e) => {
                  e.preventDefault();
                  onPageChange(page);
                  router.push(`/timelog/${reportedId}?page=${page}`);
                }}
              >
                {page}
              </PaginationLink>

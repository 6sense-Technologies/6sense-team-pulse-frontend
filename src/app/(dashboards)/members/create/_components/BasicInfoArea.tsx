  ...
  return (
    <div className="flex flex-col lg:flex-row items-start  w-full max-w-[872px] lg:pt-4 lg:gap-x-[220px]">
      <div className="pl-[6px] py-4 lg:pt-0">
        <h1 className="text-[16px] lg:text-headingXXS font-semibold lg:pb-2">Basic Info</h1>
      </div>
      <div className="w-full max-w-[420px]">
        ...
        <div className="w-full max-w-[553px] lg:pl-0 pt-4 lg:pt-0">
          <DesignationDropdown control={control} name="designation" placeholder="Select" errors={errors.designation?.message} index={0} />
        </div>
      </div>
    </div>
  );

...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          side={side}
        >
          <div className="flex h-full w-full flex-col border-red-500">{children}</div>
        </SheetContent>
      </Sheet>
    );
  }
  ...
  if (collapsible !== "none") {
    return (
      <div className={cn("flex h-full fixed min-w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground", className)} ref={ref} {...props}>
        {children}
      </div>
    );
  }
  ...
  ({ className, onClick, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        {...props}
      >
        <Menu className="!w-[24px] !h-[24px] md:!hidden" />

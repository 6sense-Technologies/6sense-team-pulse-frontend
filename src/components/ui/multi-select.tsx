          ...
          >
            {selectedValues.length > 0 ? (
                ...
                <div className="flex flex-wrap items-center gap-4">
                  {selectedValues.slice(0, maxCount).map((value) => {
                    ...
                    return (
                      <Badge
                        key={value}
                        className="bg-white text-black py-1 px-3 rounded-full hover:bg-black hover:text-white"
              ...
              <div className="flex items-center justify-between w-full mx-auto">
                <span className="text-sm text-muted-foreground mx-3 text-gray-500 font-normal">{placeholder}</span>
                ...
                <CommandItem key="all" onSelect={toggleAll} className="cursor-pointer">
                  <div
                    className={cn(
                      ...
                      selectedValues.length === options.length ? "bg-white text-primary-foreground" : "opacity-50 [&_svg]:invisible",
                    )}
                  >
                  ...
                  return (
                    <CommandItem key={option.value} onSelect={() => toggleOption(option.value)} className="cursor-pointer">
                      <div
                        className={cn(
                          "mr-2 flex h-4 w-4 items-center justify-center rounded-sm border border-primary",
                          isSelected ? "bg-white text-primary-foreground" : "opacity-50 [&_svg]:invisible",
                        )}
                      >
                        <CheckIcon className="h-4 w-4" />
                      </div>
